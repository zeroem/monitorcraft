...
wget -q -P $ROLE_DIR/logstash/files https://download.elasticsearch.org/logstash/logstash/logstash-1.3.2-flatjar.jar &
wget -q -P $ROLE_DIR/redis/files wget http://download.redis.io/releases/redis-2.8.3.tar.gz &
